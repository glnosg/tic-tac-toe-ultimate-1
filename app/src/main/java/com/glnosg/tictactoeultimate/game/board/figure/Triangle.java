...
public class Triangle implements Figure {
    ...
    private static Triangle sInstance;
    ...
    private void addFiguresToLists() {
        addShape(
                R.drawable.shape_triangle1_small_solid,
                R.drawable.shape_triangle1_small_transparent20,
                R.drawable.shape_triangle1_small_winning,
                R.drawable.shape_triangle1_small_winning_transparent20,
                R.drawable.shape_triangle1_medium_solid,
                R.drawable.shape_triangle1_medium_transparent20,
                R.drawable.shape_triangle1_medium_winning,
                R.drawable.shape_triangle1_medium_winning_transparent20,
                R.drawable.shape_triangle1_big_solid,
                R.drawable.shape_triangle1_big_transparent20,
                R.drawable.shape_triangle1_big_winning,
                R.drawable.shape_triangle1_big_winning_transparent20);
    }
    ...
    public int getBigSolidBitmapId(int shapeIndex) {
        int validShapeIndex = validateShapeIndex(shapeIndex);
        return sBigSolidIds.get(validShapeIndex);
    }

    @Override
    public int getBigWinningBitmapId(int shapeIndex) {
        int validShapeIndex = validateShapeIndex(shapeIndex);
        return sBigWinningIds.get(validShapeIndex);
    }
