...
public class Square implements Figure {
    ...
    private static Square sInstance;
    ...
    private void addFiguresToLists() {
        addShape(
                R.drawable.shape_square1_small_solid,
                R.drawable.shape_square1_small_transparent20,
                R.drawable.shape_square1_small_winning,
                R.drawable.shape_square1_small_winning_transparent20,
                R.drawable.shape_square1_medium_solid,
                R.drawable.shape_square1_medium_transparent20,
                R.drawable.shape_square1_medium_winning,
                R.drawable.shape_square1_medium_winning_transparent20,
                R.drawable.shape_square1_big_solid,
                R.drawable.shape_square1_big_transparent20,
                R.drawable.shape_square1_big_winning,
                R.drawable.shape_square1_big_winning_transparent20);
    }
